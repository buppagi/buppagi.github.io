...
background: '/img/posts/2020/03/netflixbg-netflix.png'
categories: []
tags: [IT정보, 웹스토어, 넷플릭스]
comments: true
---
...
## 확장프로그램 설치
![크롬 브라우저에서 확장프로그램 설치 하는 방법1](/img/posts/2020/03/netflix01.png)

우측 상단의 더보기(맞춤설청 및 제어) → 도구 더보기 → 확장프로그램으로 들어가시면 됩니다.

![(마우스 오버하면 말풍선으로 이름이 뜹니다.)](/img/posts/2020/03/netflix02.png)

![](/img/posts/2020/03/netflix03.png)
왼쪽 상단 기본메뉴 → 왼쪽 하단 Chrome 웹스토어 열기

![확장프로그램 바로 들어가시려면 아래 링크를 클릭하시면됩니다.](/img/posts/2020/03/netflix04.png)
...
![](/img/posts/2020/03/netflix05.png)
1. `NflxMultiSubs`으로 검색
2. `Chrome`에 추가 버튼을 눌러 추가합니다.

![웹스토어에서 NflxMultiSubs 설치방법 갈무리](/img/posts/2020/03/netflix06.png)

### NflxMultiSubs 적용
![NflxMultiSubs 영어+한국 자막이 동시 적용](/img/posts/2020/03/netflix07.png)
...
![language learning with netflix 이용방법](/img/posts/2020/03/netflix08.png)
![language learning with netflix 이용방법 가이드](/img/posts/2020/03/netflix09.png)
...
![미드 굿플레이스 LLN 적용한 갈무리](/img/posts/2020/03/netflix10.png)
...
![](/img/posts/2020/03/netflix11.png)

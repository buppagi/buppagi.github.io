...
header: 
  overlay_image: "/assets/images/posts/2019/10/discord-logo.jpg"
categories: [IT 정보]
...
![디스코드](/assets/images/posts/2019/10/discord-download.png){: .align-center}
...
## 스팀설정
![디스코드01](/assets/images/posts/2019/10/discord01.png){: .align-center}

스팀메신저에서 `Steam -> 설정`에 들어갑니다.

![디스코드02](/assets/images/posts/2019/10/discord02.png){: .align-center}

게임 중 탭에 보면 게임 내 Steam 오버레이 사용이 있습니다. 여기에 체크를 하시면됩니다.

![디스코드 설정방법](/assets/images/posts/2019/10/discord03.png){: .align-center}
...
![window 검색을 이용하여 디스코드 앱(프로그램) 찾기](/assets/images/posts/2019/10/discord04.png){: .align-center}
...
![디스코드 오른쪽 버튼을 눌러서 나온 화면](/assets/images/posts/2019/10/discord05.png){: .align-center}
...
![속성 화면](/assets/images/posts/2019/10/discord06.png){: .align-center}

![속성안에 호환성 탭 화면 갈무리](/assets/images/posts/2019/10/discord07.png){: .align-center}
...
![바탕화면에서 관리자로 실행](/assets/images/posts/2019/10/discord08.gif){: .align-center}
...
![디스코드 오버레이 설정된 화면](/assets/images/posts/2019/10/discord09.png){: .align-center}

...
$(document).ready(function() {
  ...
  (function (registerScrollPercent) {
    var THRESHOLD = 50;
    var backToTop = document.querySelector('.fix-bottom .back-to-top');
    var readingProgressBar = document.querySelector('.reading-progress-bar');
    // 페이지 새로 고침 후 페이지가 스크롤 된 경우 사이드 바에서 맨 위로 초기화합니다.
    window.addEventListener('scroll', function () {
      var scrollPercent;
      if (backToTop || readingProgressBar) {
        var docHeight = document.querySelector('.initial-content').offsetHeight;
